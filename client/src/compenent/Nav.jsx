    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav mb-2 mb-lg-0 col-4">
            <li class="nav-item hover-box p-2">
                <a href="/meme/home" className='link-dark'>
        ...
        <div class="col-4 d-sm-inline d-block">
            <a href="/meme" className='text-decoration-none text-dark' onClick={()=>{localStorage.removeItem("token")}}>
